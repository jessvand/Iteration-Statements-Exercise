...
namespace IterationStatements
{
    public class Program
    {
        ...
        public static void IncByThree(int b)
        {
        ...
        public static void CanVote()
        {
            ...
            bool canParse = int.TryParse(Console.ReadLine(), result: out int u);

            if (u >= 18)
            {
                Console.WriteLine($"You're {u}, and eligible to vote in the US...not that it nmatters. We're all screwed!");
            }
            else
            {
                Console.WriteLine($"Sorry not sorry! You're {u} and cannot vote until you're 18 years old - but don't worry. In the US, we make exceptions for certain things! You'll see...");
